 ...
 */
class SourceDataModel : public wxDataViewModel
{
public:
    /// Given an API source pointer, convert the source to a wxDataView
    SourceDataModel(recombinant::api::Source* source_);
